...
void	Editor::init(void)
{
	...
	_buttons.push_back(new Button(new Texture("Images/Choose map's size.png")));
	...
	_buttons.back()->show();
	/* 10x10 button init */
	_buttons.push_back(new Button(new Texture("Images/10x10.png")));
	_buttons.back()->setPos(
			(WINDOW_WIDTH - _buttons.back()->getWidth()) / 2,
			(WINDOW_HEIGHT / 3) + 100);
	_buttons.back()->setAction(&Editor::_start10);
	/* 20x20 button init */
	_buttons.push_back(new Button(new Texture("Images/20x20.png")));
	_buttons.back()->setPos(
			(WINDOW_WIDTH - _buttons.back()->getWidth()) / 2,
			_buttons[1]->getRect().y + _buttons[1]->getHeight() + 20);
	_buttons.back()->setAction(&Editor::_start20);
	/* 30x30 button init */
	_buttons.push_back(new Button(new Texture("Images/30x30.png")));
	_buttons.back()->setPos(
			(WINDOW_WIDTH - _buttons.back()->getWidth()) / 2,
...
void	Editor::openingAnimation(void)
{
	...
	_logo = new Texture("Images/Logo/RayLogo.png");
	if (!_logo)
	{
...
{
	_toolButtons.push_back(new Button(new Texture("Images/Spray.png"), 20, 40,
						(_logo->getRect().x - 60) / 3,
						(_logo->getRect().x - 60)/ 3));
	_toolButtons.push_back(new Button(new Texture("Images/SprayG.png"),
							20 + _toolButtons[0]->getWidth() + 10, 40,
							(_logo->getRect().x - 60) / 3,
							(_logo->getRect().x - 60)/ 3));
	_toolButtons.push_back(new Button(new Texture("Images/SprayB.png"),
...
void	Editor::start(void)
{
	...
	_buttons.push_back(new Button(new Texture("Images/START.png",
